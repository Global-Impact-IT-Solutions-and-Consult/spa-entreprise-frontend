...
export const EditServiceModal = ({ businessId, service, isOpen, onClose, onSuccess, categoryOptions, breakpoint = MOBILE_MAX }: EditServiceModalProps) => {
    ...
    // Populate form when modal opens with the service data
    useEffect(() => {
        if (service && isOpen) {
    ...
    const fields = (
        ...
        {/* Image Upload */}
        <div className="space-y-2">
            <Label className="text-sm font-medium text-gray-400">Service Image (Optional)</Label>
            {imagePreview ? (
        ...
        >
            {isMobile ? (
                <div className="px-4 pb-4 space-y-5">
                    <p className="text-xs font-normal text-gray-500">Update the details of your service</p>
                    {fields}
                </div>
            ) : (
                <div className="p-6 flex flex-col flex-1 min-h-0">
                    <DialogHeader className="mb-6 shrink-0">
                        <DialogTitle className="text-xl font-bold text-gray-900">Edit Service</DialogTitle>
                        <p className="text-xs font-normal text-gray-500">Update the details of your service</p>
                    </DialogHeader>
