...
export function BusinessInfoSidebar({ business }: BusinessSidebarProps) {
    const address = business.addressDetails?.address || business.address;
                ...
                <div className="grid grid-cols-1 gap-3 mt-8">
                    {address && (
                        <a 
                            ...
                            className="h-12 flex items-center justify-center rounded-md border border-gray-100 bg-gray-50/50 font-bold gap-2 text-gray-700 hover:bg-gray-100 transition-all"
                        >
                    ...
                    <div className="flex gap-4">
                        {business.instagramUrl && (
                            <a 
                                ...
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="p-3 bg-gray-50 rounded-md text-gray-500 hover:text-[#E89D24] hover:bg-yellow-50 transition-all"
                            >
